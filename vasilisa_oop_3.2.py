...
class Temperature:
    ...
    def __add__(self, delta: 'Temperature'):
        new_elem = self.degrees + delta.degrees

        if new_elem > (-100) and new_elem < 100:
            return new_elem
        else:
            return 'net :3'
        
    def __sub__(self, delta: 'Temperature'):
        new_elem = self.degrees - delta.degrees
